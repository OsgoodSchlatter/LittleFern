    ...
    >
      ...
      >
        ...
        >
          Small space.
          <br />
          <em style={{ color: "var(--brick)" }}>Big</em> mornings.
        </h1>
        ...
        >
          Brunch, hand-crafted pastries and exceptional coffee — inside a
          converted brick terrace on Regent Street.
        </p>
        ...
        >
          <a
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.background = "var(--brick-light)")
            }
            onMouseLeave={(e) =>
          ...
          <a
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.borderColor = "rgba(244,239,232,0.5)")
            }
            onMouseLeave={(e) =>
              (e.currentTarget.style.borderColor = "rgba(244,239,232,0.2)")
            }
          >
            Reserve
          </a>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        <div
          ...
          style={{
            position: "absolute",
            inset: "-20%",
            background: `url('/_people_pos.jpg') center/cover no-repeat`,
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to right, rgba(44,40,37,0.4) 0%, transparent 40%)",
          }}
        />
      </div>
